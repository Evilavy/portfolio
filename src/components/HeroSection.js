    ...
    <div className="min-h-[60vh] flex flex-col-reverse gap:14 lg:gap-0 lg:flex-row items-center justify-between">
      <div className="space-y-10 text-center lg:text-left mt-20 lg:mt-0">
        <h1 className="text-4xl lg:text-7xl font-bold md:mt-16 lg:mt-0">
          Bonjour ! <span className="wave hover:rotate-45 transition duration-300 ease-in-out">👋</span> <br />
          <span className="underline underline-offset-8 decoration-[#004AAD]">
            Je m'appelle <span className="text-[#004AAD]">Evilavy</span>
          </span>
        </h1>
      ...
      <div className="relative">
        <div className="sm:w-72 sm:h-72 w-68 h-68 space-y-3 -rotate-[30deg] relative mt-12">
          <div className="flex gap-3 translate-x-8">
            <div className="sm:w-32 sm:h-32 w-24 h-24 rounded-xl bg-[#afd2ff] float-animation float-delay-1"></div>
            <div className="sm:w-32 sm:h-32 w-24 h-24 rounded-full bg-[#004AAD] float-animation float-delay-2"></div>
          </div>

          <div className="flex gap-3 -translate-x-8">
            <div className="sm:w-32 sm:h-32 w-24 h-24 rounded-xl bg-[#004AAD] float-animation float-delay-2"></div>
            <div className="sm:w-32 sm:h-32 w-24 h-24 rounded-full bg-[#afd2ff] float-animation float-delay-1"></div>
          </div>
          <div className="glow absolute top-[40%] right-1/2 -z-10"></div>
        </div>
        <div className="absolute bottom-5 sm:bottom-14 left-0 sm:-left-10">
          <MovingBorderBtn borderRadius="0.5rem" className="p-3 font-semibold">
            <a target="blank_" href={CV}>📣 Recherche une Alternance - Voir CV</a>
          </MovingBorderBtn>
        </div>
      </div>
    </div>
